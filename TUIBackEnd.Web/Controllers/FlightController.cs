...
namespace TUIBackEnd.Web.Controllers
{
    ...
    public class FlightController : BaseController
    {
        ...
        IFlightBLL _flightBLL;
        IAirportBLL _airportBLL;

        public FlightController(IFlightBLL flightBLL, IAirportBLL airportBLL)
        {
        ...
        {
            List<Flight> flightList = _flightBLL.GetFlightsList();
        ...
        public ResponseModel AddFlight([FromBody] Flight param)
        {
            ...
            try
            {
                ...
                var airportList =_airportBLL.GetAirportsList().ToList();
                Airport departureAirport = airportList.First(elt => elt.Id == param.DepartureAirportId);
                Airport destinationAirport = airportList.First(elt => elt.Id == param.DestinationAirportId);
        ...
        public ResponseModel UpdadteFlight([FromBody] Flight param)
        {
            ...
            flight.DepartureAirportId = param.DepartureAirportId;
            flight.DestinationAirportId = param.DestinationAirportId;
